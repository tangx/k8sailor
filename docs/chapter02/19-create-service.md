...
![nodeport-port-targetport](/docs/assets/img/19/nodeport-port-targetport.png)
...
![service-headless](/docs/assets/img/19/service-headless.png)
...
![service-external-name](/docs/assets/img/19/service-external-name.png)
